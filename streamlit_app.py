...
def main():
    ...
    language_choices = ["All", "en", "fr", "ja", "it", "de", "es", "sv", "fi", "zh", "ru"]
                       ...
                       # Nettoyer le titre du film en enlevant les caractères spéciaux
                        ...
                        if tmdb_id:
                            ...
                            if movie_details:
                                ...
                                col2.write(f"**Release Date:** {movie_details['release_date']}" + "           " + f"**Genres:** {', '.join(genre['name'] for genre in movie_details['genres'])}")
...
def build_query(movie_name, selected_genre, selected_language, average_rating, release_year):
    ...
    base_query += f" GROUP BY m.title HAVING AVG(r.rating) >= {average_rating}" 
